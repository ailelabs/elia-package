 ...
 * API: tabs, messages (real data replaces the scripted demo),
 * onSend(text), placeholder.
 * ───────────────────────────────────────────────────────── */
...
export interface ChatComposerProps {
  tabs?: string[];
  /** When set, renders this conversation instead of the scripted demo. */
...
export default function ChatComposer({
  ...
  const isDemo = messages === undefined;
